...
public class MyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String dir = request.getParameter("text");
        ...
        if (file != null) {
            content = newJerseyClient.findFile(dir, file);
        } else {
            content = newJerseyClient.getContent(dir);
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action=\"index.html\" method=\"GET\">\n"
                    + "            <input type=\"submit\"  name=\"button\" value=\"Вернуться\">\n"
                    + "        </form>");
            out.println("</body>");
